...
export function ExportDataDialog({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Dialog */}
      <div className="relative w-full max-w-md mx-4 rounded-2xl border border-theme-border-secondary bg-theme-bg-elevated shadow-2xl backdrop-blur-xl max-h-[80vh] flex flex-col">
        {/* Header */}
